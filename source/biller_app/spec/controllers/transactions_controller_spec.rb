...
describe TransactionsController do
  ...
  let(:valid_attributes) { { "paid" => "false", "refunded" => "true" } }
  let(:failed_transactions_attribute) { { "paid" => "false", "refunded" => "true" } }
  let(:successful_transactions_attribute) { { "paid" => "true",  } }
  let(:disputed_transactions_attribute) { { "paid" => "false", "refunded" => "false" } }
  ...
  describe "GET index" do
    it "assigns transactions to disputed, succesful and failed transactions" do

      failed_transactions = Transaction.create! failed_transactions_attribute
      successful_transactions = Transaction.create! successful_transactions_attribute
      disputed_transactions = Transaction.create! disputed_transactions_attribute

      get :index, {}, valid_session

      assigns(:failed_transactions).to_a.should eq([failed_transactions])
      assigns(:successful_transactions).to_a.should eq([successful_transactions])
      assigns(:disputed_transactions).to_a.should eq([disputed_transactions])
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved transaction as @transaction" do
        ...
        post :create, {:transaction => { "paid" => "invalid value" }}, valid_session
        assigns(:transaction).should be_a_new(Transaction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transaction" do
        ...
        Transaction.any_instance.should_receive(:update).with({ "paid" => "false" })
        put :update, {:id => transaction.to_param, :transaction => { "paid" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the transaction as @transaction" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Transaction.any_instance.stub(:save).and_return(false)
        put :update, {:id => transaction.to_param, :transaction => { "paid" => "invalid value" }}, valid_session
        assigns(:transaction).should eq(transaction)
      end
